var app = app || {};
(function ($) {
    app.SigmaCodelistview = Element.View.extend({
		pages : ["Global Settings", "Common Codes", "SigmaCode"],
        render: function () {
            var self = this;
            app.TemplateManager.get("../../modules/global/tpl/tpl_SigmaCodelistview.html", function (template) {
                ...
                $(self.el).find("#controls").html(new app.component.SearchControl({
                    options: [
						...
						, { Value: "CodeCategory", Name: "CodeCategory" }
						, { Value: "CodeName", Name: "CodeName" }
                ...
                $(self.el).find("#list").html(new app.component.Tablelist({
                    list: "../../modules/global/tpl/tpl_SigmaCodelist.html",
                    listitem: "../../modules/global/tpl/tpl_SigmaCodelistitem.html",
                    coll: "new app.SigmaCodelist()",
                    query: self.options.query
                }).render().el);
                ...
                $(self.el).find("#btnAdd").on("click", function () {
                    app.component.Modal.show(new app.SigmaCodecreate({ model: new app.SigmaCode() }), 600);
                });
                ...
                $(self.el).find("#btnImportHistory").on("click", function () {
                    app.router.navigate("SigmaCodeimportlist", { trigger: true })
                });
        ...
        link: function (key) {
            app.component.Modal.show(new app.SigmaCodecreate({ model: new app.SigmaCode({ Code: arguments[0], CodeCategory: arguments[1] }) }), 600);
        }
